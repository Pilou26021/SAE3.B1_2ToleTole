...
<header>
    ...
    <a href="connexion_pro.html"><img src="<?php echo ($professionel || $membre) ? $result['pathimage'] : 'img/User.png'; ?>" alt="image user" title="image user" style="width: 30px; height: 30px;"></a>
</header>

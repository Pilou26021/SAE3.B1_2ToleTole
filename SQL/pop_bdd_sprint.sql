...
-- 11. Insérer des données dans `_alerter-offre`
INSERT INTO `_alerter-offre` (idSignalement, idOffre) VALUES 
(1, 1),
(2, 2);

-- 12. Insérer des données dans `_alerter-avis`
INSERT INTO `_alerter-avis` (idSignalement, idAvis) VALUES 
(1, 1),
(2, 2);

...
CREATE TABLE public._professionnelPrive (
    ...
    idPro BIGINT NOT NULL,
    coordBancairesIBAN TEXT CHECK (16 <= LENGTH(coordBancairesIBAN) AND LENGTH(coordBancairesIBAN) <= 34),
    coordBancairesBIC TEXT CHECK (8 <= LENGTH(coordBancairesBIC) AND LENGTH(coordBancairesBIC) <= 11),
